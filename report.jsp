    ...
    <body>
        ...
        <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="books.jsp">View Book</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="books.jsp">Books available</a></li>
                                            </ul>
                                        </li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>@</td>
                                                            ...
                                                            <div class="clear"></div>
                                                            <input type="submit" value="View report" name="report" class="button btn btn-default">
                                                            <div class="clear"></div>
                                                        </form> 
                                                    </div>
                                                </div>
